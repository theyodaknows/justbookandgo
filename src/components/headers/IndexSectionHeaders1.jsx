  ...
  <div className="container px-4 mx-auto">
    <nav className="flex justify-between items-center py-6">
      ...
      <div className="lg:hidden">
        <button className="flex items-center py-2 px-3 text-blue-600 hover:text-blue-700 rounded border border-blue-200 hover:border-blue-300">
    ...
    <div className="flex flex-wrap items-center justify-center max-w-4xl mx-auto pt-8 pb-12">
      <div className="w-1/2 md:w-1/3 lg:w-1/5 px-3 mb-8">
        <img className="mx-auto" src="metis-assets/logos/brands/tesla.svg" alt="" />
      </div>
      <div className="w-1/2 md:w-1/3 lg:w-1/5 px-3 mb-8">
        <img className="mx-auto" src="metis-assets/logos/brands/facebook.svg" alt="" />
      </div>
      <div className="w-1/2 md:w-1/3 lg:w-1/5 px-3 mb-8">
        <img className="mx-auto" src="metis-assets/logos/brands/marvel.svg" alt="" />
      </div>
      <div className="w-1/2 md:w-1/3 lg:w-1/5 px-3 mb-8">
        <img className="mx-auto" src="metis-assets/logos/brands/nike.svg" alt="" />
      </div>
      <div className="hidden md:block w-1/2 md:w-1/3 lg:w-1/5 px-3 mb-8">
        <img className="mx-auto" src="metis-assets/logos/brands/airbnb.svg" alt="" />
      </div>
    </div>
  </div>
